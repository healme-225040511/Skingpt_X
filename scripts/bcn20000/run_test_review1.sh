...
nohup python $SCRIPT_PATH --task_file $TXT_DIR/test_split_2.txt --image_dir $IMAGE_BASE_DIR --gpu_id 1 --neo4j_uri $NEO4J_URI --neo4j_user neo4j --neo4j_password $NEO4J_PASS --mode main --eval_dir $EVAL_DIR --main_csv $MAIN_CSV > $LOG_DIR/processor1.log 2>&1 &
nohup python $SCRIPT_PATH --task_file $TXT_DIR/test_split_3.txt --image_dir $IMAGE_BASE_DIR --gpu_id 2 --neo4j_uri $NEO4J_URI --neo4j_user neo4j --neo4j_password $NEO4J_PASS --mode main --eval_dir $EVAL_DIR --main_csv $MAIN_CSV > $LOG_DIR/processor2.log 2>&1 &
nohup python $SCRIPT_PATH --task_file $TXT_DIR/test_split_4.txt --image_dir $IMAGE_BASE_DIR --gpu_id 3 --neo4j_uri $NEO4J_URI --neo4j_user neo4j --neo4j_password $NEO4J_PASS --mode main --eval_dir $EVAL_DIR --main_csv $MAIN_CSV > $LOG_DIR/processor3.log 2>&1 &
