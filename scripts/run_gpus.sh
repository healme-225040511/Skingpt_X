...
case "$1" in
  start)
    echo "🚀 [第 1 阶段] 启动前 4 个任务 (Agent Type 2) ..."
    ...
    #   --output_root /225040511/project/Evaluation_Results/fitzpatrick17k/test1 \
    #   --pending_set_path /225040511/project/Skingpt_X/process_list/fitzpatrick17k/test/process_list1.txt > "$LOG_DIR/gpu1.log" 2>&1 &

    # CUDA_VISIBLE_DEVICES=1 nohup python $WORK_DIR/AgentWorkflowEvaluator.py \
    #   --dataset_root /fitzpatrick17k/V002/dataset/test \
    #   --is_single_agent True --agent_type 2 \
    #   --output_root /225040511/project/Evaluation_Results/fitzpatrick17k/test2 \
    #   --pending_set_path /225040511/project/Skingpt_X/process_list/fitzpatrick17k/test/process_list2.txt > "$LOG_DIR/gpu2.log" 2>&1 &

    # CUDA_VISIBLE_DEVICES=2 nohup python $WORK_DIR/AgentWorkflowEvaluator.py \
    #   --dataset_root /fitzpatrick17k/V002/dataset/test \
    #   --is_single_agent True --agent_type 2 \
    #   --output_root /225040511/project/Evaluation_Results/fitzpatrick17k/test3 \
    #   --pending_set_path /225040511/project/Skingpt_X/process_list/fitzpatrick17k/test/process_list3.txt > "$LOG_DIR/gpu3.log" 2>&1 &
    ...
    # echo "🚀 [第 2 阶段] 前序任务已完成，启动后 4 个任务 ..."

    # CUDA_VISIBLE_DEVICES=0 nohup python $WORK_DIR/AgentWorkflowEvaluator.py \
    #   --dataset_root /fitzpatrick17k/V002/dataset/test \
    #   --output_root /225040511/project/Evaluation_Results/fitzpatrick17k/test1 \
    #   --pending_set_path /225040511/project/Skingpt_X/process_list/fitzpatrick17k/test/process_list1.txt > "$LOG_DIR/gpu5.log" 2>&1 &

    # CUDA_VISIBLE_DEVICES=1 nohup python $WORK_DIR/AgentWorkflowEvaluator.py \
    #   --dataset_root /fitzpatrick17k/V002/dataset/test \
    #   --output_root /225040511/project/Evaluation_Results/fitzpatrick17k/test2 \
    #   --pending_set_path /225040511/project/Skingpt_X/process_list/fitzpatrick17k/test/process_list2.txt > "$LOG_DIR/gpu6.log" 2>&1 &

    # CUDA_VISIBLE_DEVICES=2 nohup python $WORK_DIR/AgentWorkflowEvaluator.py \
    #   --dataset_root /fitzpatrick17k/V002/dataset/test \
    #   --output_root /225040511/project/Evaluation_Results/fitzpatrick17k/test3 \
    #   --pending_set_path /225040511/project/Skingpt_X/process_list/fitzpatrick17k/test/process_list3.txt > "$LOG_DIR/gpu7.log" 2>&1 &

    # CUDA_VISIBLE_DEVICES=3 nohup python $WORK_DIR/AgentWorkflowEvaluator.py \
    #   --dataset_root /fitzpatrick17k/V002/dataset/test \
    #   --output_root /225040511/project/Evaluation_Results/fitzpatrick17k/test4 \
    #   --pending_set_path /225040511/project/Skingpt_X/process_list/fitzpatrick17k/test/process_list4.txt > "$LOG_DIR/gpu8.log" 2>&1 &
