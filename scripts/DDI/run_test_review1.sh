...
# --- 路径配置 ---
TXT_DIR="/225040511/project/Skingpt_X/process_list/DDI/test"
SCRIPT_PATH='/225040511/project/Skingpt_X/eval_case_review.py'
LOG_DIR="./case_revew"
MAIN_CSV="/225040511/project/Evaluation_Results/DDI/SkinGPT-X/panderm_test_predictions.csv"
IMAGE_BASE_DIR="/225040511/Dataset/DDI/dataset"
EVAL_DIR='/225040511/project/Evaluation_Results/DDI/SkinGPT-X/'
