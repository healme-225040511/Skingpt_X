...
nohup python $SCRIPT_PATH --task_file $TXT_DIR/failed_cases1.txt --image_dir $IMAGE_BASE_DIR --gpu_id 0 --neo4j_uri $NEO4J_URI --neo4j_user neo4j --neo4j_password $NEO4J_PASS --mode main --eval_dir /225040511/project/Evaluation_Results/fitzpatrick17k/SkinGPT-X/ --main_csv $MAIN_CSV > $LOG_DIR/processor0.log 2>&1 &
