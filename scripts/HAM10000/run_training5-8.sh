...
# TXT 分片文件所在的目录
TXT_DIR="/225040511/project/Skingpt_X/process_list/HAM10000/train"

EVAL_DIR='/225040511/project/Evaluation_Results/HAM10000/SkinGPT-X'

IMAGE_DIR='/225040511/Dataset/HAM10000'
# 日志保存目录
