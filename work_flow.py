...
class EvaluationWorkflow:
    def __init__(self, 
        ...
        # 4. 输出路径（按模式区分）
        self.vision_cache_path = os.path.join(self.eval_dir, f"test_vision_findings_gpu.json")
...
if __name__ == "__main__":
    ...
    workflow = EvaluationWorkflow(
        ...
        disease_names=DERMNET_SUB_DISEASE_NAME,
        sub_disease_names=DERMNET_SUB_DISEASE_NAME if args.mode == "sub" else None,
        mode=args.mode,
        gpu_id=args.gpu_id,
